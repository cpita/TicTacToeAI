...
<img src="https://render.githubusercontent.com/render/math?math=G_t=R_T\gamma^{T-t-1}">. If <img src="https://render.githubusercontent.com/render/math?math=\gamma = 0"> our agent will only care about the inmediate reward, and if <img src="https://render.githubusercontent.com/render/math?math=\gamma = 1"> it will give the same importance to future rewards as to immediate rewards. In this case we will set <img src="https://render.githubusercontent.com/render/math?math=\gamma = 0.9"> but many other values will work too. 
